      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/services#security" className="text-gray-300 hover:text-accent transition duration-300">Segurança da Informação</Link></li>
              <li><Link href="/services#digital" className="text-gray-300 hover:text-accent transition duration-300">Transformação Digital</Link></li>
              <li><Link href="/services#analytics" className="text-gray-300 hover:text-accent transition duration-300">Análise de Dados</Link></li>
              <li><Link href="/services#cloud" className="text-gray-300 hover:text-accent transition duration-300">Infraestrutura Cloud</Link></li>
              <li><Link href="/services#web" className="text-gray-300 hover:text-accent transition duration-300">Desenvolvimento Web</Link></li>
              <li><Link href="/services#consulting" className="text-gray-300 hover:text-accent transition duration-300">Consultoria Técnica</Link></li>
            </ul>
          </div>
