...
export default function NessContactPage() {
  ...
  // Buscar informações de contato da administração
  ...
  const content = {
    pt: {
      ...
      subtitle: 'pronto para acelerar sua operação digital?',
      intro: 'nossa equipe está preparada para entender suas necessidades e desenvolver soluções modulares personalizadas para seu negócio.',
    ...
    en: {
      ...
      subtitle: 'ready to accelerate your digital operation?',
      intro: 'our team is prepared to understand your needs and develop customized modular solutions for your business.',
    ...
    es: {
      ...
      subtitle: '¿listo para acelerar su operación digital?',
      intro: 'nuestro equipo está preparado para entender sus necesidades y desarrollar soluciones modulares personalizadas para su negocio.',
