  ...
  return (
    ...
    >
      ...
      <section className="conteudo bg-gradient-to-b from-white to-[#f2f8fd] text-gray-800" style={{ padding: "4rem 0" }}>
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl  font-normal mb-4 lowercase text-gray-800">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-16 max-w-6xl mx-auto">
            {language === 'pt' && (
              <>
                <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300">
                  <div className="mb-6">
                    <h3 className="text-xl  font-normal mb-4 text-gray-800">assessment</h3>
                  </div>
                  <p className="mb-4">
                ...
                <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300">
                  <div className="mb-6">
                    <h3 className="text-xl  font-normal mb-4 text-gray-800">certificações</h3>
                  </div>
                  <p className="mb-4">
                ...
                <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300 md:col-span-2">
                  <div className="mb-6">
                    <h3 className="text-xl  font-normal mb-4 text-gray-800">privacidade</h3>
                  </div>
                  <p className="mb-4">
            ...
            {language === 'en' && (
              <>
                ...
                <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300">
                  <div className="mb-6">
                    <h3 className="text-xl  font-normal mb-4 text-gray-800">certifications</h3>
                  </div>
                  <p className="mb-4">
                ...
                <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300 md:col-span-2">
                  <div className="mb-6">
                    <h3 className="text-xl  font-normal mb-4 text-gray-800">privacy</h3>
                  </div>
                  <p className="mb-4">
            ...
            {language === 'es' && (
              <>
                ...
                <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300">
                  <div className="mb-6">
                    <h3 className="text-xl  font-normal mb-4 text-gray-800">certificaciones</h3>
                  </div>
                  <p className="mb-4">
                ...
                <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300 md:col-span-2">
                  <div className="mb-6">
                    <h3 className="text-xl  font-normal mb-4 text-gray-800">privacidad</h3>
                  </div>
                  <p className="mb-4">
      ...
      <section id="what-we-do" className="conteudo bg-[#1a1a22] text-white" style={{ padding: "4rem 0" }}>
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl  font-normal text-white mb-8 lowercase">
