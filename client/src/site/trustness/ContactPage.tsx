...
export default function TrustnessContactPage() {
  ...
  const { data: contactInfo, isLoading: isLoadingContact } = useQuery({
    ...
    queryFn: async () => {
      try {
        ...
        return {
          email: 'contato@trustness.com.br',
  ...
  const content = {
    pt: {
      ...
      subtitle: 'precisa de consultoria em conformidade e privacidade?',
      intro: 'nossa equipe de especialistas está pronta para ajudar sua organização a alcançar e manter a conformidade com as mais rigorosas normas de privacidade e proteção de dados.',
    ...
    en: {
      ...
      subtitle: 'need compliance and privacy consulting?',
      intro: 'our team of experts is ready to help your organization achieve and maintain compliance with the most rigorous privacy and data protection standards.',
    ...
    es: {
      ...
      subtitle: '¿necesita consultoría en conformidad y privacidad?',
      intro: 'nuestro equipo de especialistas está listo para ayudar a su organización a alcanzar y mantener el cumplimiento con los estándares más rigurosos de privacidad y protección de datos.',
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">{contactInfo?.email || 'contato@trustness.com.br'}</p>
                    </div>
                  </div>
